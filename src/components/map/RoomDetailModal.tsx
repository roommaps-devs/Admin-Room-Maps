        ...
        <div className="flex-1 p-8 flex flex-col relative">
          ...
          <div className="flex items-center gap-4 mb-8">
            <div className="flex flex-col">
              ...
              <span className="text-2xl font-black text-[var(--primary)]">₹{room.rent.toLocaleString('en-IN')}<span className="text-sm text-gray-400 font-bold">/mo</span></span>
            </div>
          ...
          <div className="flex flex-col gap-3 mt-auto">
            <button className="w-full py-5 bg-[var(--primary)] text-white rounded-2xl font-black text-lg shadow-[0_15px_35px_rgba(255,82,17,0.3)] hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3">
            ...
            <div className="flex gap-3">
              ...
              <button className="w-14 h-14 bg-gray-50 text-gray-400 rounded-2xl flex items-center justify-center hover:text-[var(--primary)] hover:bg-[var(--primary)]/5 transition-all border border-gray-100">
                <Heart size={20} />
              </button>
